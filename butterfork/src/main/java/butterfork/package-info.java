 ...
 * {@link butterfork.BindView @BindView} on fields.</li>
 * <li>Group multiple views in a {@linkplain java.util.List list} or array.
 * Operate on all of them at once with
 * {@linkplain butterfork.ButterKnife#apply(java.util.List, ButterKnife.Action)
 * actions}, {@linkplain butterfork.ButterKnife#apply(java.util.List,
 * ButterKnife.Setter, Object) setters}, or
 * {@linkplain butterfork.ButterKnife#apply(java.util.List, android.util.Property, Object)
 * properties}.</li>
 * <li>Eliminate anonymous inner-classes for listeners by annotating methods with
 * {@link butterfork.OnClick @OnClick} and others.</li>
